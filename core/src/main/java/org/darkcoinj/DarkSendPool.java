...
public class DarkSendPool {
    ...
    static final int MIN_PEER_PROTO_VERSION = 70001;
    ...
    */
    ...
    class ThreadCheckDarkSendPool implements Runnable {
        ...
        public void run() {
            ...
            //RenameThread("jadepay-darksend");
            log.info("--------------------------------------\nstarting jadepay-darksend thread");
            int tick = 0;
            try {
    ...
    public boolean startBackgroundProcessing()
    {
        if(backgroundThread == null)
        {
            ...
            backgroundThread = new ContextPropagatingThreadFactory("jadepay-privatesend").newThread(threadCheckDarkSendPool);
