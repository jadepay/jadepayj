...
public class Context {
    ...
    // Jadepay Specific
    //
    private boolean initializedJadepay = false;
    public void initJadepay(boolean liteMode, boolean allowInstantX) {
        ...
        initializedJadepay = true;
    }

    public void closeJadepay() {
        //Jadepay Specific
        sporkManager = null;
        ...
        initializedJadepay = false;
    }

    public void initJadepaySync(String directory)
    {
