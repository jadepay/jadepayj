...
public class MasternodeBroadcast extends Masternode {
    ...
    boolean checkAndUpdate()//int& nDos
    {
        ...
        if (params.getId().equals(NetworkParameters.ID_MAINNET)) {
            if (address.getPort() != 22155) return false;
...
*/
    ...
    boolean checkInputsAndAdd()
    {
        ...
        */
        ...
        // should be at least not earlier than block when 1000 JADEPAY tx got MASTERNODE_MIN_CONFIRMATIONS
        /*
        uint256 hashBlock = 0;
        CTransaction tx2;
        ...
        {
            CBlockIndex* pMNIndex = (*mi).second; // block for 1000 JADEPAY tx -> 1 confirmation
