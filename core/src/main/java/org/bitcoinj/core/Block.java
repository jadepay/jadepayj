...
import com.hashengineering.crypto.Jad8;
...
public class Block extends Message {
    ...
    static final long ALLOWED_TIME_DRIFT = 5 * 60; // Same value as Bitcoin Core.
    ...
    private static final long START_MASTERNODE_PAYMENTS = 1533186000L; //Thursday, August 2, 2018 5:00:00 AM GMT
    ...
    private static final long START_MASTERNODE_PAYMENTS_TESTNET = 1420837558;
    ...
    protected void parse() throws ProtocolException {
        ...
        nonce = readUint32();
        hash = Sha256Hash.wrapReversed(Jad8.jad8Digest(payload, offset, cursor - offset));
    ...
    private Sha256Hash calculateHash() {
        try {
            ...
            writeHeader(bos);
            return Sha256Hash.wrapReversed(Jad8.jad8Digest(bos.toByteArray()));
        } catch (IOException e) {
