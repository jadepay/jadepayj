...
public class MainNetParams extends AbstractBitcoinNetParams {
    public static final int MAINNET_MAJORITY_WINDOW = 1024;
    ...
    public MainNetParams() {
        ...
        dumpedPrivateKeyHeader = 128; // SECRET_KEY
...
/*
        ...
        dnsSeeds = new String[] {
                ...
                "dnsseed.bitcoin.jadepayjr.org",   // Luke Jadepayjr
