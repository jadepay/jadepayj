...
public class PaymentProtocol {
    ...
    public static final String MIMETYPE_PAYMENTREQUEST = "application/jadepay-paymentrequest";
    public static final String MIMETYPE_PAYMENT = "application/jadepay-payment";
    public static final String MIMETYPE_PAYMENTACK = "application/jadepay-paymentack";
