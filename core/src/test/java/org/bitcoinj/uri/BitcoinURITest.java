...
public class BitcoinURITest {
    ...
    public void testConvertToBitcoinURI() throws Exception {
        ...
        assertEquals("jadepay:" + MAINNET_GOOD_ADDRESS, BitcoinURI.convertToBitcoinURI(goodAddress, null, null, null));
        assertEquals("jadepay:" + MAINNET_GOOD_ADDRESS, BitcoinURI.convertToBitcoinURI(goodAddress, null, "", ""));
    ...
    public void testMultiplePaymentProtocolReq() throws Exception {
        BitcoinURI uri = new BitcoinURI(MAINNET,
                "jadepay:?r=https%3A%2F%2Fbitcoincore.org%2F%7Egavin&r1=bt:112233445566");
    ...
    public void testNoPaymentProtocolReq() throws Exception {
        BitcoinURI uri = new BitcoinURI(MAINNET, "jadepay:" + MAINNET_GOOD_ADDRESS);
    ...
    public void testUnescapedPaymentProtocolReq() throws Exception {
        BitcoinURI uri = new BitcoinURI(TestNet3Params.get(),
                "jadepay:?r=https://merchant.com/pay.php?h%3D2a8628fc2fbe");
