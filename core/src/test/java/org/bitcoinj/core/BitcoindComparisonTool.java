...
/**
 * A tool for comparing the blocks which are accepted/rejected by jadepayd/jadepayj
 * It is designed to run as a testnet-in-a-box network between a single jadepayd node and jadepayj
...
public class BitcoindComparisonTool {
    ...
    public static void main(String[] args) throws Exception {
        ...
        System.out.println("USAGE: jadepayjBlockStoreLocation runExpensiveTests(1/0) [port=18444]");
