...
public class CoinTest {
    ...
    public void testToFriendlyString() {
        assertEquals("1.00 JADEPAY", COIN.toFriendlyString());
        assertEquals("1.23 JADEPAY", valueOf(1, 23).toFriendlyString());
        assertEquals("0.001 JADEPAY", COIN.divide(1000).toFriendlyString());
        assertEquals("-1.23 JADEPAY", valueOf(1, 23).negate().toFriendlyString());
    }
