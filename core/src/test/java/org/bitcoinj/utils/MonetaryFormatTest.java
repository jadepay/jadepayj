...
public class MonetaryFormatTest {
    ...
    public void standardCodes() throws Exception {
        assertEquals("JADEPAY 0.00", MonetaryFormat.BTC.format(Coin.ZERO).toString());
        assertEquals("mJADEPAY 0.00", MonetaryFormat.MBTC.format(Coin.ZERO).toString());
        assertEquals("µJADEPAY 0", MonetaryFormat.UBTC.format(Coin.ZERO).toString());
    }

    @Test
    public void customCode() throws Exception {
        assertEquals("dJADEPAY 0", MonetaryFormat.UBTC.code(1, "dJADEPAY").shift(1).format(Coin.ZERO).toString());
    }
    ...
    public void noCode() throws Exception {
        ...
        assertEquals("dJADEPAY 0", MonetaryFormat.UBTC.noCode().code(1, "dJADEPAY").shift(1).format(Coin.ZERO).toString());
    }

    @Test
    public void codeOrientation() throws Exception {
        assertEquals("JADEPAY 0.00", MonetaryFormat.BTC.prefixCode().format(Coin.ZERO).toString());
        assertEquals("0.00 JADEPAY", MonetaryFormat.BTC.postfixCode().format(Coin.ZERO).toString());
    }

    @Test
    public void codeSeparator() throws Exception {
        assertEquals("JADEPAY@0.00", MonetaryFormat.BTC.codeSeparator('@').format(Coin.ZERO).toString());
    }
