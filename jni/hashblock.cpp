/**
 * Created by Hash Engineering on 7/12/18 for the Jad8 algorithm
 */
#include "hashblock.h"
#include <inttypes.h>
...
static const JNINativeMethod methods[] = {
    { "jad8_native", "([B)[B", (void *) hash11_native }
};
...
jint JNI_OnLoad(JavaVM *vm, void *reserved) {
    ...
    jclass cls = (env)->FindClass("com/hashengineering/crypto/Jad8");
